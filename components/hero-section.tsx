    ...
    >
      ...
      <div className="max-w-7xl mx-auto w-full px-4 pt-24 pb-8 flex flex-col lg:flex-row items-center gap-12 lg:gap-20 relative z-10">
        ...
        >
          ...
          <div
            className={`flex flex-wrap items-center gap-4 mt-8 transition-all duration-1000 delay-500 ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"
              }`}
          >
            <a
              href="#contact"
            ...
            <a
              href="/resume.pdf"
              download
              className="group relative inline-flex items-center gap-2.5 px-7 py-4 rounded-2xl font-semibold transition-all duration-300 border-2 border-primary/40 hover:border-primary bg-primary/5 hover:bg-primary/10 text-primary hover:shadow-lg hover:shadow-primary/20 hover:-translate-y-0.5"
            >
          ...
          >
            {[
              { icon: Github, href: "https://github.com/karthikeyen007", label: "GitHub" },
              { icon: Linkedin, href: "https://www.linkedin.com/in/karthikeyan-v-0714672b5/", label: "LinkedIn" },
            ...
            {/* LeetCode - custom SVG since Lucide doesn't have it */}
            <a
              href="https://leetcode.com/u/karthi_t/"
              target="_blank"
              rel="noopener noreferrer"
              className="group w-12 h-12 rounded-xl bg-card border border-border/50 flex items-center justify-center hover:border-primary/50 hover:bg-primary/5 transition-all duration-300 hover:scale-110 hover:-translate-y-1"
              aria-label="LeetCode"
            ...
            >
              <svg
                ...
                width={20}
                height={20}
                className="text-muted-foreground group-hover:text-primary transition-colors fill-current"
              >
